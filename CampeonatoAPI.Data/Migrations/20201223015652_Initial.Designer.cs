...
namespace CampeonatoAPI.Data.Migrations
{
    ...
    [Migration("20201223015652_Initial")]
            ...
            modelBuilder.Entity("CampeonatoAPI.Domain.Entities.CampeonatoEntity", b =>
                {
                    ...
                    b.HasIndex("CodigoCampeonato")
                        .IsUnique()
                        .HasFilter("[CodigoCampeonato] IS NOT NULL");
            ...
            modelBuilder.Entity("CampeonatoAPI.Domain.Entities.TimeEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4052aac6-8580-4d96-ac8e-fc6e0211a173"),
                            Nome = "São Paulo",
                            isDeleted = false
                        },
                        new
                        {
                            Id = new Guid("672e7116-3374-48dc-b2e6-224bb0fcdb2c"),
                            Nome = "Flamengo",
                            isDeleted = false
                        },
                        new
                        {
                            Id = new Guid("b0372680-0183-4392-88af-5ca2bcb84dd1"),
                            Nome = "Corinthians",
                            isDeleted = false
                        });
                });
